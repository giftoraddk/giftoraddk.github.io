...
const baseConfig = {
	...
	tiers: [
		// ── Tier 0: Dashboard screenshot (static, col-7, row-span 2) ─────────
      ...
      anime: 'flip-in-diag-tr',
		...
		// ── Tier 1: Intro heading (static, col-5) ────────────────────────────
		{
			groupCol: [12],
			groupRow: ['auto'],
			groupJustify: ['none'],
  ...
  bg: {
    // ...getStyleOpts({ rounded: '0', tint: '#ffc75f', total: 2, blobType: 'circleOverlap', blobMove: 'move', deg: 315 }),
