...
// Grid layout (12-col):
//  Row 1 │ intro          col-6  │ map  col-6  gi-row-2  │
//  Row 2 │ contact items  col-6  │ map continues          │
//
...
const baseConfig = {
	...
	tiers: [
		// ── Tier 0: Map — web-a block with background image (col-6, gi-row-2) ─
		// Entire block is a clickable <a> linking to Google Maps.
		// Background-image from placehold.co acts as visual map placeholder.
    [{
			groupCol: [12],
			groupRow: ['auto'],
			groupJustify: ['none'],
      ...
      anime: 'swirl-in-fwd',
		...
		// meta.email, không dùng field top-level nào — title/description đã thuộc Tier 1 Intro
