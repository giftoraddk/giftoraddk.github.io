...
export class WebSteps extends LitElement {
    ...
    _rbCircleContent(status, index) {
        ...
        if (status === 'active')  return html`<svg class="loader" viewBox="0 0 24 24" fill="none"><circle cx="12" cy="12" r="10" stroke="currentColor" stroke-width="3" stroke-linecap="round" stroke-dasharray="40 63" /></svg>`
